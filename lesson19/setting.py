...
MATH_POSITIONS = {
    '/' : {'col': 3, 'row': 2, 'character':'', 'operator':'/', 'image path': {'light':'img/light_div.png','dark':'img/dark_div.png'}},
...
OPERATORS = {
    ...
    'invert' : {'col': 1, 'row': 2, 'text':'', 'image path': {'light':'img/light_invert.png','dark':'img/dark_invert.png'}},
